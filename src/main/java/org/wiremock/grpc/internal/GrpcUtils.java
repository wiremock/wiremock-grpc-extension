...
public class GrpcUtils {
  ...
  public static <T extends ServerBuilder<T>> T buildAndBindServices(
    ...
    List<BindableService> services = buildServices(fileDescriptors, stubRequestHandler);
  ...
  private static List<BindableService> buildServices(
      List<Descriptors.FileDescriptor> fileDescriptors, StubRequestHandler stubRequestHandler) {
